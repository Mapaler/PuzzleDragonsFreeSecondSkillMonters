...
var monsterList = [
    {group: "第一个扳机-群马县；获取：特殊地下城最后一个-ぐんまコラボ",ids: [
        439, //群馬縣
        440, //超・群馬縣
        3999, //究極・群馬縣
    ]},
    {group: "第一个抽蛋扳机-蛮龙；获取：龙契桶活动，（也可以免费用练技的小龙）",ids: [
        3946, //蠻龍契士・他迪斯
        3947, //裂爪的蠻龍契士・他迪斯
        3963, //木書龍
    ]},
    {group: "第二个免费扳机-小火狗；获取：实况野球合作活动刷币交易所换取",ids: [
        4678, //干達
    ]},
    {group: "第一个防封的扳机（第三只免费）-万圣灯龙；获取：イネ降臨！-灯龙唤士（万圣节以外也有时开放）",ids: [
        4832, //遊戲之燈龍喚士・舞寧
        4833, //古城之燈龍喚士・舞寧
    ]},
    {group: "目前最难获取的扳机-光爱猫；获取：抽徽章",ids: [
        4993, //陽風之愛貓神・芭絲特
    ]},
];
