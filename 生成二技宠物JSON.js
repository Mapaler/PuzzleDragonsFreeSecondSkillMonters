...
var monsterList = [
    ...
    {group: "第三方合作（限时）：赠送",ids: [
        4780, //PAD隊＆伊麗莎白衣裝
        4879, //導航妖精・結衣
    ]},
    {group: "第三方合作（限时）：宠物交换所",ids: [
        4388, //摩爾迦納
        4672, //早川葵
        4678, //干達
        4778, //定春
    ...
    {group: "第三方合作（限时）：MP商店-怪物猎人装备（较多单独列出）",ids: [
        3705, //猎人♂・雄火龙X装备
        3706, //猎人♂・泡狐龙X装备
        3707, //猎人♂・鏖魔装备
        4171, //猎人♂・碎龙 X 装备
